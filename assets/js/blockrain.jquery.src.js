...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    _createUI: function() {
      ...
      backgroundaudio.src = "assets/audio/backgroundaudio.ogg";
      backgroundaudio.volume = 0.1;
      backgroundaudio.autoPlay = false;
      backgroundaudio.preLoad = true;
...
window.BlockrainThemes = {
  'custom': {
    ...
    backgroundGrid: 'data:image/png;base64,',
    complexBlocks: {
